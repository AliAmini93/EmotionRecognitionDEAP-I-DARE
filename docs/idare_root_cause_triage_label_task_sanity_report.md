# I-DARE Root-Cause Triage Label/Task Sanity Report
...
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_alternative_formulation_pair_guardrails.csv:2` — PAIR_GUARD_001,Only within-subject pairs are allowed.,fail_smoke_tests,Avoids cross-subject rating-scale semantics that contributed to archived failure.
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_alternative_formulation_pair_guardrails.csv:3` — PAIR_GUARD_002,No pair may contain a held-out subject in train folds.,fail_smoke_tests,Maintains LOSO subject-disjoint protocol.
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_alternative_formulation_pair_guardrails.csv:5` — PAIR_GUARD_004,Ambiguous or tied pairs must be excluded or explicitly audited.,fail_or_fix_before_training,Weak pair labels would repeat label-semantics bottleneck.
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_alternative_formulation_pair_guardrails.csv:7` — PAIR_GUARD_006,A no-feature/position/majority baseline must remain near chance.,fail_or_fix_before_training,Prevents trivial artifact-driven task success.
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_minimal_redesigned_task_metric_conflict_audit.csv:2` — EEG,valence,-0.010522113541458251,-0.020680536072404665,-0.03306754128155209,0.5016693297244023,-0.011130770077244034,no_positive_rank_signal,not_confirmable
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_minimal_redesigned_task_metric_conflict_audit.csv:3` — EMG,arousal,-0.0197887940153521,-0.0037260145154925928,-0.006542318312283579,0.47747942486010814,0.009338060991177568,no_positive_rank_signal;q33_not_strict_chance,not_confirmable
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_minimal_redesigned_task_metric_conflict_audit.csv:4` — EMG,valence,0.019171068580299766,-0.021386912828270932,-0.0801157323820253,0.5070515450953589,0.0033614784728453174,positive_spearman_but_mae_worse;positive_spearman_but_rmse_worse,weak_signal_metric_conflict
- `/mnt/HDD/AliWorks/EmotionRecognitionDEAP-I-DARE-root-cause-triage/docs/idare_label_semantics_minimal_redesigned_task_metric_conflict_audit.csv:5` — EEG,arousal,0.006946207794990916,-0.015202638436321969,-0.028743806947596706,0.5048829233537683,0.008219972097111684,positive_spearman_but_mae_worse;positive_spearman_but_rmse_worse,weak_signal_metric_conflict
...
- Only existing cache/index metadata and committed docs were read.
