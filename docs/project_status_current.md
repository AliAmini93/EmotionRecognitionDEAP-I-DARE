...
- A controlled I-DARE label-policy ablation objective is defined in `docs/idare_label_policy_ablation_objective.md`; only the 144-run EEG/EMG mainline label-policy matrix is authorized.
