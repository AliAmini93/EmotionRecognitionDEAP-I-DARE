...
ORACLE_PRED = ROCA_DIR / "eeg_gaussian10_arousal_test_oracle_predictions_current.csv"
CLEAN_PRED = ROCA_DIR / "eeg_gaussian10_full_loso_predictions_current.csv"
ORACLE_FOLD = ROCA_DIR / "eeg_gaussian10_arousal_test_oracle_fold_summary_current.csv"

OUT_MD = ROCA_DIR / "eeg_arousal_oracle_diagnostic_current.md"
OUT_JSON = ROCA_DIR / "eeg_arousal_oracle_diagnostic_current.json"
OUT_POOLED = ROCA_DIR / "eeg_arousal_oracle_diagnostic_pooled_current.csv"
OUT_SUBJECT = ROCA_DIR / "eeg_arousal_oracle_diagnostic_subject_current.csv"
OUT_COMPARISON = ROCA_DIR / "eeg_arousal_oracle_diagnostic_comparison_current.csv"
OUT_FAILURE = ROCA_DIR / "eeg_arousal_oracle_diagnostic_failure_current.csv"
OUT_EPOCH = ROCA_DIR / "eeg_arousal_oracle_diagnostic_epoch_current.csv"


ORACLE_MODEL = "eeg_bc_residual_huber_norm_gaussian10_arousal_test_oracle"
CLEAN_MODEL = "eeg_bc_residual_huber_norm_gaussian10_full_loso"
...
def main():
    ...
    lines = []
    lines.append("# EEG Arousal Oracle Diagnostic")
    lines.append("")
