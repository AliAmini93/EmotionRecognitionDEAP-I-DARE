    ...
    decision_rows = [
        {
            ...
            "interpretation": "640 samples at 128 Hz is 5 seconds, which matches the I-DARE 5s stimulus-window policy; it is shorter only relative to DEAP's 60s video stimulus.",
            "risk_for_06a1": "For I-DARE this is the intended full stimulus window; remaining risk is whether this 5s stimulus contains enough residual-relevant physiology.",
            "decision": "I_DARE_5S_FULL_STIMULUS_WINDOW_CONFIRMED",
            "required_before_final_claim": "Document that 640 samples represent the full 5s I-DARE stimulus after 512Hz-to-128Hz downsampling, with preceding 5s BSL used for baseline correction.",
        },
        {
        ...
        },
        {
            ...
            "interpretation": "Current ready-to-train I-DARE EEG cache is a full 5s stimulus window; no missing 60s window is expected for I-DARE.",
            "risk_for_06a1": "Architecture search is fair for I-DARE if reported as 5s stimulus-window representation learning; do not compare this window policy directly to DEAP 60s without separation.",
            "decision": "RUN_06A1_ON_CONFIRMED_I_DARE_5S_WINDOW",
            "required_before_final_claim": "If 06a1 fails, do not blame missing I-DARE stimulus duration; investigate model/target/representation and optionally compare alternative segments or multimodal context.",
        },
        {
    ...
    candidate_config_rows = [
        {
            ...
            "window_policy": "full I-DARE 5s STIM window at 128Hz; preceding 5s BSL used for baseline correction",
            ...
            "non_success_interpretation": "Failure means the current 5s I-DARE stimulus-window prototype failed; representation learning is not exhausted.",
        },
        {
